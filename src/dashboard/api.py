...
def build_dashboard_state(client: redis.Redis, limit: int = 500) -> dict[str, Any]:
    ...
    for cell in cells:
        ...
        pipeline.zcount(f"strikes:{cell}", now_us - 300_000_000, now_us)
    ...
    return {
        ...
        "summary": {
            ...
            "strikes_5m": sum(row["strike_count_5m"] for row in rows),
